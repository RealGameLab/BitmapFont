...
private:
	bool ImportBitmapFont(class UFont* Font, const TCHAR* Buffer, const FString &PackageName, const FString &FileName);
	class UTexture2D* CreateTexture2D(const FString &FullFilePath, const FString &PackageName);
};
